...
docker build --platform linux/amd64 -t "${FULL}" /Users/sourabh/vendure/storefront-prepwize
...
kubectl -n prepwise-storefront set image deployment/prepwise-storefront app="${FULL}"

echo "Waiting for rollout..."
kubectl -n prepwise-storefront rollout status deployment/prepwise-storefront

echo "Deployment updated to ${FULL}"
kubectl -n prepwise-storefront get pods -l app=prepwise-storefront -o wide
