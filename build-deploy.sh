...
kubectl -n storefrontstage set image deployment/storefrontstage app="${FULL}"

echo "Waiting for rollout..."
kubectl -n storefrontstage rollout status deployment/storefrontstage

echo "Deployment updated to ${FULL}"
kubectl -n storefrontstage get pods -l app=storefrontstage -o wide